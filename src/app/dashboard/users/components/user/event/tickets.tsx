...
const Item = ({ userId }: { userId: string }) => {
  ...
  const hasTicket = ((userInfo?.firstName.length % 7 ) > 0);
  ...
  return (userInfo &&
    <div className="flex gap-3 w-[100%]">
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-gray-400 text-[13px]"> {userInfo?.lastName} • {moment(userInfo?.updatedAt).format("M")} Tickets </p>
      </div>
