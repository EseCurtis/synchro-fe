import { eventTotalTicketIcon, titcketValueIcon } from '@/app/_components/icons/preview/eventsStatIcons';
import { bookedServiceIcon, serviceCreatedIcon, serviceIncomeIcon, totalServiceBookedIcon } from '@/app/_components/icons/preview/serviceStatIcon';
import {
    userFollowersIcon,
    userBlockedIcon,
    userFollowingIcon,
  } from '@/app/_components/icons/preview/usersStatIcon';
import { bookedValueIcon, bookedVenueIcon, totalVenueIcon, venueCreatedIcon } from '@/app/_components/icons/preview/venuesStatIcon';
